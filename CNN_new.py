...
dataX = loadtxt('./Dataset/UNSW_NB15/UNSW_NB15.csv', skiprows=1, delimiter=',', usecols=range(5, 43))
dataY = loadtxt('./Dataset/UNSW_NB15/UNSW_NB15.csv', skiprows=1, delimiter=',', usecols=44)
